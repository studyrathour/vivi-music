package com.songify.app.update.updatenotification
...
import com.songify.app.constants.KEY_SHOW_UPDATE_NOTIFICATION
import com.songify.app.constants.SettingsShapeColorTertiaryKey
import com.songify.app.constants.ShowUpdateNotificationKey
import com.songify.app.ui.component.IconButton
import com.songify.app.ui.screens.KEY_AUTO_UPDATE_CHECK
import com.songify.app.ui.screens.PREFS_NAME
...
import com.songify.app.update.experiment.saveUpdateCheckInterval
...
fun UpdateInfoScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            val (showNewsIcon, onShowNewsIconChange) = rememberPreference(com.songify.app.constants.ShowNewsIconKey, true)
