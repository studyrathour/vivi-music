...
fun PowerSaverSettings(
    ...
    val (settingsShapeTertiary, _) = rememberPreference(com.songify.app.constants.SettingsShapeColorTertiaryKey, false)
    val (darkMode, _) = rememberEnumPreference(
        com.songify.app.constants.DarkModeKey,
        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                if (powerSaver) {
                    ...
                    item {
                        val (powerSaverPureBlack, onPowerSaverPureBlackChange) = rememberPreference(com.songify.app.constants.PowerSaverPureBlackKey, defaultValue = true)
                        val (powerSaverHighRefresh, onPowerSaverHighRefreshChange) = rememberPreference(com.songify.app.constants.PowerSaverHighRefreshRateKey, defaultValue = true)
                        val (powerSaverDiscord, onPowerSaverDiscordChange) = rememberPreference(com.songify.app.constants.PowerSaverDiscordKey, defaultValue = true)
                        val (powerSaverLastFM, onPowerSaverLastFMChange) = rememberPreference(com.songify.app.constants.PowerSaverLastFMKey, defaultValue = true)
                        val (powerSaverLyrics, onPowerSaverLyricsChange) = rememberPreference(com.songify.app.constants.PowerSaverLyricsKey, defaultValue = true)
                        val (powerSaverPauseOnZeroVolume, onPowerSaverPauseOnZeroVolumeChange) = rememberPreference(com.songify.app.constants.PowerSaverPauseOnZeroVolumeKey, defaultValue = true)
