...
fun PowerSaverSettings(
    ...
    val (settingsShapeTertiary, _) = rememberPreference(com.songify.suraj.constants.SettingsShapeColorTertiaryKey, false)
    val (darkMode, _) = rememberEnumPreference(
        com.songify.suraj.constants.DarkModeKey,
        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                if (powerSaver) {
                    ...
                    item {
                        val (powerSaverPureBlack, onPowerSaverPureBlackChange) = rememberPreference(com.songify.suraj.constants.PowerSaverPureBlackKey, defaultValue = true)
                        val (powerSaverHighRefresh, onPowerSaverHighRefreshChange) = rememberPreference(com.songify.suraj.constants.PowerSaverHighRefreshRateKey, defaultValue = true)
                        val (powerSaverDiscord, onPowerSaverDiscordChange) = rememberPreference(com.songify.suraj.constants.PowerSaverDiscordKey, defaultValue = true)
                        val (powerSaverLastFM, onPowerSaverLastFMChange) = rememberPreference(com.songify.suraj.constants.PowerSaverLastFMKey, defaultValue = true)
                        val (powerSaverLyrics, onPowerSaverLyricsChange) = rememberPreference(com.songify.suraj.constants.PowerSaverLyricsKey, defaultValue = true)
                        val (powerSaverPauseOnZeroVolume, onPowerSaverPauseOnZeroVolumeChange) = rememberPreference(com.songify.suraj.constants.PowerSaverPauseOnZeroVolumeKey, defaultValue = true)
