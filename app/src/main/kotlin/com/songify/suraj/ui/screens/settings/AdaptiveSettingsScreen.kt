            ...
            AnimatedPane {
                ...
                if (route != null) {
                    when (route) {
                        ...
                        "settings/content/romanization" -> RomanizationSettings(navController, scrollBehavior, onBack = { navigator.navigateBack() })
                        "settings/storage" -> StorageSettings(navController, scrollBehavior, onBack = { navigator.navigateBack() })
